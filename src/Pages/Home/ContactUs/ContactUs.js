        ...
        <div class="container mt-5">
            ...
            <div class="row">
                <div class="col-sm-12 text-center mb-4">
                    {/* <a class="btn btn-success" target="_blank" href="https://www.paypal.com/webapps/shoppingcart?flowlogging_id=f8876459b9ac2&mfid=1619175810225_f8876459b9ac2#/checkout/openButton"> Donate Now <i class="fa fa-dollar"></i></a> */}
                    ...
                    <div class="card border-success rounded-0">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="text-center">
                                <input type="submit" name="submit" value="submit" class="btn btn-success btn-block rounded-0 py-2" />
                            </div>
                ...
                <div class="col-sm-12 col-md-7">
                    ...
                    <div class="row text-center">
                        <div class="col-md-4">
                            <a class="bg-success px-3 py-2 rounded text-white mb-2 d-inline-block"><i class="fa fa-map-marker"></i></a>
                            <p> Your Address ….. </p>
                        </div>
                        <div class="col-md-4">
                            <a class="bg-success px-3 py-2 rounded text-white mb-2 d-inline-block"><i class="fa fa-phone"></i></a>
                            <p>+91- 90000000</p>
                        </div>
                        <div class="col-md-4">
                            <a class="bg-success px-3 py-2 rounded text-white mb-2 d-inline-block"><i class="fa fa-envelope"></i></a>
                            <p> your@gmail.com</p>
                        </div>
                    </div>
                </div>
